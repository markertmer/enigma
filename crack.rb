...
if ARGV.count != 3 || !File.exist?(ARGV[0]) || (ARGV[1].include?("/") && !File.exist?(ARGV[1].split("/")[0..-2].join("/"))) || ARGV[2].length != 6 || ARGV[2].to_i.to_s != ARGV[2]
...
# invalid date:
# ruby decrypt.rb ./file/test_encryption.txt ./file/test_crack.txt 16012
# ruby decrypt.rb ./file/test_encryption.txt ./file/test_crack.txt 1601222
# ruby decrypt.rb ./file/test_encryption.txt ./file/test_crack.txt 160l22

# wrong number of arguments:
# ruby decrypt.rb ./file/test_encryption.txt ./file/test_crack.txt
# ruby decrypt.rb ./file/test_encryption.txt ./file/test_crack.txt 160122 160122
